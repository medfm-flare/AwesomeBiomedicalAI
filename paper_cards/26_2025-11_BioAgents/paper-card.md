# Paper Card: BioAgents: Bridging the gap in bioinformatics analysis with multi-agent systems
...
|---|---|---|
| BioAgents | Author- or catalogue-used system name | Preserve exact capitalization; do not expand beyond the source |
...
| evaluation set | Bioinformatics tool documentation used to fine-tune the conceptual-genomics agent | Treat as evaluation evidence, not training data, unless explicitly labelled |

## 01 Basic Information

- **Title:** BioAgents: Bridging the gap in bioinformatics analysis with multi-agent systems
- **Model / system:** BioAgents
- **Venue and date:** Sci. Rep. 2025-11
- **Official source:** [https://www.nature.com/articles/s41598-025-25919-z](https://www.nature.com/articles/s41598-025-25919-z)
- **Code:** https://github.com/microsoft/bioinformagus
- **Modalities:** See the paper for task-specific modalities.
- **Source note:** The card is page-grounded to the official PDF.

## 02 One-Sentence Summary

[Analysis] BioAgents uses Two specialized Phi-3 agents for conceptual genomics and workflow knowledge, plus a Phi-3 reasoning agent that integrates their outputs; retrieval-augmented generation supports workflow documentation to address Bioinformatics workflow design, conceptual genomics question answering, tool selection and troubleshooting of multi-step analysis pipelines; the evidence is bounded to Bioinformatics tool documentation used to fine-tune the conceptual-genomics agent and the evaluation conditions reported in the paper. [Paper: PDF p. 1]
...
- **Surface method:** [Paper] Two specialized Phi-3 agents for conceptual genomics and workflow knowledge, plus a Phi-3 reasoning agent that integrates their outputs; retrieval-augmented generation supports workflow documentation [Paper: PDF pp. 1–2]
- **Training / adaptation:** [Paper] Fine-tuning of a Phi-3 specialized agent on bioinformatics tool documentation [Paper: PDF pp. 1–2]
...
**Backbone and tool configuration:** Two specialized Phi-3 agents for conceptual genomics and workflow knowledge, plus a Phi-3 reasoning agent that integrates their outputs; retrieval-augmented generation supports workflow documentation [Paper: PDF pp. 1–2]
...
**Data / population:** Bioinformatics tool documentation used to fine-tune the conceptual-genomics agent [Paper: PDF p. 1]

**Downstream tasks:** Bioinformatics workflow design, conceptual genomics question answering, tool selection and troubleshooting of multi-step analysis pipelines [Paper: PDF p. 1]
...
- **Data boundary:** Bioinformatics tool documentation used to fine-tune the conceptual-genomics agent [Paper: PDF p. 1]
- **Model dependence:** Results are conditional on Two specialized Phi-3 agents for conceptual genomics and workflow knowledge, plus a Phi-3 reasoning agent that integrates their outputs; retrieval-augmented generation supports workflow documentation [Paper: PDF pp. 1–2]
