# Paper Card: Accelerating primer design for amplicon sequencing using large language model-powered agents
...
>
> Card completeness: Complete relative to the processed source (38 PDF pages)

## Terminology Ledger

| Canonical term | First-use definition | Decision |
|---|---|---|
| PrimeGen | Author- or catalogue-used system name | Preserve exact capitalization; do not expand beyond the source |
...
- **Model / system:** PrimeGen
- **Venue and date:** Nat. Biomed. Eng. 2025-07
- **Official source:** [https://www.nature.com/articles/s41551-025-01455-z](https://www.nature.com/articles/s41551-025-01455-z)
- **Code:** https://github.com/melobio/PrimeGen
- **Modalities:** See the paper for task-specific modalities.
- **Source note:** The card is page-grounded to the official PDF.

## 02 One-Sentence Summary

[Analysis] PrimeGen uses GPT-4o central controller coordinating search, primer-design, protocol and experiment agents; the experiment agent includes a vision-language model for anomaly detection to address Gene-target retrieval, multiplex primer design, executable liquid-handler protocol generation, robot-script execution and visual detection of experimental anomalies; the evidence is bounded to N/A and the evaluation conditions reported in the paper. [Paper: PDF p. 1]
...
- **Surface method:** [Paper] GPT-4o central controller coordinating search, primer-design, protocol and experiment agents; the experiment agent includes a vision-language model for anomaly detection [Paper: PDF pp. 1–2]
...
**Backbone and tool configuration:** GPT-4o central controller coordinating search, primer-design, protocol and experiment agents; the experiment agent includes a vision-language model for anomaly detection [Paper: PDF pp. 1–2]

![Figure 1 — faithful PDF page view](<figures/page-004.png>)

*Figure 1 is embedded as an unchanged PDF page view. It contributes Overview of PrimeGen workflow. [image] [Paper: PDF p. 4, Figure 1]*
...
**Downstream tasks:** Gene-target retrieval, multiplex primer design, executable liquid-handler protocol generation, robot-script execution and visual detection of experimental anomalies [Paper: PDF p. 1]
...
| Case study or deployment-style test | Whether the workflow yields a meaningful end product | Domain-specific examples | Gene-target retrieval, multiplex primer design, executable liquid-handler protocol generation, robot-script execution and visual detection of experimental anomalies | Feasibility for the reported cases | Prospective reliability across sites or domains | [Paper: main result figures] |

![Figure 2 — faithful PDF page view](<figures/page-004.png>)

*Figure 2 is embedded as an unchanged PDF page view. It contributes The workflow of the search agent and primer agent. [image] [Paper: PDF p. 4, Figure 2]*

![Figure 3 — faithful PDF page view](<figures/page-004.png>)

*Figure 3 is embedded as an unchanged PDF page view. It contributes Experiment result analysis. [Paper: PDF p. 4, Figure 3]*

![Figure 4 — faithful PDF page view](<figures/page-005.png>)

*Figure 4 is embedded as an unchanged PDF page view. It contributes The workflow of the protocol agent. [image] [Paper: PDF p. 5, Figure 4]*

![Figure 5 — faithful PDF page view](<figures/page-005.png>)

*Figure 5 is embedded as an unchanged PDF page view. It contributes Overview of the liquid handling system and anomaly detection workflow. [image] [Paper: PDF p. 5, Figure 5]*
...
- **Model dependence:** Results are conditional on GPT-4o central controller coordinating search, primer-design, protocol and experiment agents; the experiment agent includes a vision-language model for anomaly detection [Paper: PDF pp. 1–2]
