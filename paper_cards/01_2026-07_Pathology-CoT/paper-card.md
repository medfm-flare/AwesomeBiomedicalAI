# Paper Card: Pathology-CoT: learning visual chain-of-thought agents from expert whole-slide image diagnosis behaviour
...
>
> Card completeness: Complete relative to the processed source (25 PDF pages)

## Terminology Ledger

| Canonical term | First-use definition | Decision |
|---|---|---|
| Pathology-CoT | Author- or catalogue-used system name | Preserve exact capitalization; do not expand beyond the source |
...
| evaluation set | Expert pathologist navigation logs, inspection regions and human-reviewed rationales from colorectal lymph-node and dermatopathology whole-slide-image cohorts | Treat as evaluation evidence, not training data, unless explicitly labelled |

## 01 Basic Information

- **Title:** Pathology-CoT: learning visual chain-of-thought agents from expert whole-slide image diagnosis behaviour
- **Model / system:** Pathology-CoT
- **Venue and date:** Nat. Biomed. Eng. 2026-07
- **Official source:** [https://www.nature.com/articles/s41551-026-01739-y](https://www.nature.com/articles/s41551-026-01739-y)
- **Code:** https://github.com/zhihuanglab/Pathology-CoT
- **Modalities:** See the paper for task-specific modalities.
- **Source note:** The card is page-grounded to the official PDF.

## 02 One-Sentence Summary

[Analysis] Pathology-CoT uses Two-stage visual agent combining a learned behaviour predictor for region-of-interest navigation with vision-language-model reasoning to address Autonomous whole-slide-image navigation, suspicious-region localization, behaviour-guided diagnostic reasoning and explainable cancer diagnosis; the evidence is bounded to Expert pathologist navigation logs, inspection regions and human-reviewed rationales from colorectal lymph-node and dermatopathology whole-slide-image cohorts and the evaluation conditions reported in the paper. [Paper: PDF p. 1]
...
- **Surface method:** [Paper] Two-stage visual agent combining a learned behaviour predictor for region-of-interest navigation with vision-language-model reasoning [Paper: PDF pp. 1–2]
- **Training / adaptation:** [Paper] Supervised training of the behaviour predictor from expert whole-slide-image viewing trajectories and reviewed visual rationales [Paper: PDF pp. 1–2]
...
**Backbone and tool configuration:** Two-stage visual agent combining a learned behaviour predictor for region-of-interest navigation with vision-language-model reasoning [Paper: PDF pp. 1–2]

![Figure 1 — faithful PDF page view](<figures/page-004.png>)

*Figure 1 is embedded as an unchanged PDF page view. It contributes Framework for converting expert viewing behaviour into agent-ready training data. [image] [Paper: PDF p. 4, Figure 1]*
...
**Data / population:** Expert pathologist navigation logs, inspection regions and human-reviewed rationales from colorectal lymph-node and dermatopathology whole-slide-image cohorts [Paper: PDF p. 1]

**Downstream tasks:** Autonomous whole-slide-image navigation, suspicious-region localization, behaviour-guided diagnostic reasoning and explainable cancer diagnosis [Paper: PDF p. 1]
...
| Case study or deployment-style test | Whether the workflow yields a meaningful end product | Domain-specific examples | Autonomous whole-slide-image navigation, suspicious-region localization, behaviour-guided diagnostic reasoning and explainable cancer diagnosis | Feasibility for the reported cases | Prospective reliability across sites or domains | [Paper: main result figures] |

![Figure 2 — faithful PDF page view](<figures/page-004.png>)

*Figure 2 is embedded as an unchanged PDF page view. It contributes Overview of Pathology-o3 and its performance. [image] [Paper: PDF p. 4, Figure 2]*

![Figure 3 — faithful PDF page view](<figures/page-004.png>)

*Figure 3 is embedded as an unchanged PDF page view. It contributes Quantitative and qualitative results on the external LNCO2 validation cohort. [image] [Paper: PDF p. 4, Figure 3]*

![Figure 4 — faithful PDF page view](<figures/page-004.png>)

*Figure 4 is embedded as an unchanged PDF page view. It contributes Analysis of reasoning length and order. [image] [Paper: PDF p. 4, Figure 4]*

![Figure 5 — faithful PDF page view](<figures/page-004.png>)

*Figure 5 is embedded as an unchanged PDF page view. It contributes Comparison of different ‘thinking’ modes and cost–benefit analysis. [image] [Paper: PDF p. 4, Figure 5]*

![Figure 6 — faithful PDF page view](<figures/page-004.png>)

*Figure 6 is embedded as an unchanged PDF page view. It contributes Performance evaluation on the external dermatopathology cohort. [Paper: PDF p. 4, Figure 6]*

## 11 Correct Interpretation of the Conclusions

- **Task scope:** The paper supports the listed tasks, not unrestricted autonomous research or care. [Paper: PDF p. 1]
- **Data boundary:** Expert pathologist navigation logs, inspection regions and human-reviewed rationales from colorectal lymph-node and dermatopathology whole-slide-image cohorts [Paper: PDF p. 1]
- **Model dependence:** Results are conditional on Two-stage visual agent combining a learned behaviour predictor for region-of-interest navigation with vision-language-model reasoning [Paper: PDF pp. 1–2]
...
**Prospective guarded evaluation of Pathology-CoT.** [Hypothesis] A calibrated abstention policy plus clinician approval will preserve most useful actions while reducing severe errors. Delta: add risk-tiered action permissions and uncertainty-triggered handoff. Validation: prospective silent deployment on an external site, followed by a preregistered clinician-in-the-loop comparison; primary endpoints are severe-error rate, calibration, time, and resource use. Falsifier: no reduction in severe errors or clinically important delay. Failure modes: workflow adaptation, alert fatigue, distribution shift. Innovation status: unverified; prior-art search required.