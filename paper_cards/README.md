...
| [Genomics-aware Clinical Agent](06_2026-06_Genomics-Aware_Clinical_Agent/paper-card.md) | Optimizing genomics-aware clinical agents in precision oncology | npj Syst. Biol. Appl. 2026-06 | New page-grounded card |
...
| [Pharmacogenomic Recommendation Agent](11_2026-04_Pharmacogenomic_Recommendation_Agent/paper-card.md) | An agentic AI system for automated pharmacogenomic recommendation generation | npj Digit. Med. 2026-04 | New page-grounded card |
| [EcoRxAgent](12_2026-04_EcoRxAgent/paper-card.md) | EcoRxAgent: an AI agent for generating economically substitutable prescriptions | npj Digit. Med. 2026-04 | New page-grounded card |
...
| [AgentClinic](14_2026-04_AgentClinic/paper-card.md) | AgentClinic: a multimodal benchmark for tool-using clinical AI agents | npj Digit. Med. 2026-04 | Reused from prior audited public library |
...
| [CellVoyager](17_2026-03_CellVoyager/paper-card.md) | CellVoyager: AI CompBio agent generates new insights by autonomously analyzing biological data | Nat. Methods 2026-03 | New page-grounded card |
| [Orchestrated Clinical Agents](18_2026-03_Orchestrated_Clinical_Agents/paper-card.md) | Orchestrated multi agents sustain accuracy under clinical-scale workloads compared to a single agent | npj Health Syst. 2026-03 | New page-grounded card |
...
| [Clinical Agent Benchmark](21_2026-02_Clinical_Agent_Benchmark/paper-card.md) | Benchmarking large language model-based agent systems for clinical decision tasks | npj Digit. Med. 2026-02 | Reused from prior audited public library |
| [CellAtria](22_2026-01_CellAtria/paper-card.md) | An agentic AI framework for ingestion and standardization of single-cell RNA-seq data analysis | npj Artif. Intell. 2026-01 | New page-grounded card |
...
| [AIPatient](25_2025-12_AIPatient/paper-card.md) | Simulated patient systems powered by large language model-based AI agents offer potential for transforming medical education | Commun. Med. 2025-12 | New page-grounded card |
| [BioAgents](26_2025-11_BioAgents/paper-card.md) | BioAgents: Bridging the gap in bioinformatics analysis with multi-agent systems | Sci. Rep. 2025-11 | New page-grounded card |
...
| [PrimeGen](28_2025-07_PrimeGen/paper-card.md) | Accelerating primer design for amplicon sequencing using large language model-powered agents | Nat. Biomed. Eng. 2025-07 | New page-grounded card |
| [CRISPR-GPT](29_2025-07_CRISPR-GPT/paper-card.md) | CRISPR-GPT for agentic automation of gene-editing experiments | Nat. Biomed. Eng. 2025-07 | New page-grounded card |
...
| [GeneAgent](31_2025-07_GeneAgent/paper-card.md) | GeneAgent: self-verification language agent for gene-set analysis using domain databases | Nat. Methods 2025-07 | New page-grounded card |
| [Coscientist](32_2023-12_Coscientist/paper-card.md) | Autonomous chemical research with large language models | Nature 2023-12 | New page-grounded card |
