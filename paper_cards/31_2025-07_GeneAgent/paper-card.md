# Paper Card: GeneAgent: self-verification language agent for gene-set analysis using domain databases
...
>
> Card completeness: Complete relative to the processed source (20 PDF pages)

## Terminology Ledger

| Canonical term | First-use definition | Decision |
|---|---|---|
| GeneAgent | Author- or catalogue-used system name | Preserve exact capitalization; do not expand beyond the source |
...
- **Model / system:** GeneAgent
- **Venue and date:** Nat. Methods 2025-07
- **Official source:** [https://www.nature.com/articles/s41592-025-02748-6](https://www.nature.com/articles/s41592-025-02748-6)
...
[Analysis] GeneAgent uses GPT-4 agent with a four-stage generation, self-verification, modification and summarization loop that autonomously queries expert-curated biological databases through web APIs to address Gene-set functional interpretation, biological-process naming, claim-level database verification, hallucination correction and evidence-grounded gene-function discovery; the evidence is bounded to N/A and the evaluation conditions reported in the paper. [Paper: PDF p. 1]
...
- **Surface method:** [Paper] GPT-4 agent with a four-stage generation, self-verification, modification and summarization loop that autonomously queries expert-curated biological databases through web APIs [Paper: PDF pp. 1–2]
...
**Backbone and tool configuration:** GPT-4 agent with a four-stage generation, self-verification, modification and summarization loop that autonomously queries expert-curated biological databases through web APIs [Paper: PDF pp. 1–2]

![Figure 1 — faithful PDF page view](<figures/page-002.png>)

*Figure 1 is embedded as an unchanged PDF page view. It contributes Framework of GeneAgent for gene-set analysis. a, An overview of Gene­ Agent, containing generation, self-verification, modification and summarization. The self-verification module is iterated through the modification module. b, The workflow of GeneAgent in the gene-set analysis. When obtaining the input gene [Paper: PDF p. 2, Figure 1]*
...
- [Paper] **Equation 8:** 280 718 115 GSEA (8) [Paper: PDF p. 7, Equation 8]

## 10 Experimental Design and Evidence Chain

**Data / population:** N/A [Paper: PDF p. 1]

**Downstream tasks:** Gene-set functional interpretation, biological-process naming, claim-level database verification, hallucination correction and evidence-grounded gene-function discovery [Paper: PDF p. 1]

**Inventoried tables:**

- **Table 1** — The statistics for gene sets used in our study Gene sets used for empirical evaluation. [Paper: PDF p. 4, Table 1]
- **Table 2** — Examples of gene sets that are assigned with different biological process names and similarity scores Gene sets named by different methods. ID [Paper: PDF p. 6, Table 2]
- **Table 3** — The comparison analysis of different methods in the case study Results of GeneAgent and GPT-4 in the case study. ID GPT-4 [Paper: PDF p. 8, Table 3]
...
| Case study or deployment-style test | Whether the workflow yields a meaningful end product | Domain-specific examples | Gene-set functional interpretation, biological-process naming, claim-level database verification, hallucination correction and evidence-grounded gene-function discovery | Feasibility for the reported cases | Prospective reliability across sites or domains | [Paper: main result figures] |

![Figure 2 — faithful PDF page view](<figures/page-005.png>)

*Figure 2 is embedded as an unchanged PDF page view. It contributes The biological process names generated by GeneAgent are more similar with their ground truth than those produced by GPT-4 using the prompts proposed by Hu et al.16. a, The ROUGE scores of GeneAgent and GPT-4 were evaluated across three datasets: 1,000 gene sets from GO, 50 from NeST and [Paper: PDF p. 5, Figure 2]*

![Figure 3 — faithful PDF page view](<figures/page-007.png>)

*Figure 3 is embedded as an unchanged PDF page view. It contributes GeneAgent mitigates hallucinations by autonomously accessing Web APIs to interact with domain databases. a, Statistics of the outcome of the 15,903 claims collected from the 1,106 gene sets, including the proportion of the categorizations made by selfVeri-Agent. ‘Successfully’ denotes that the claims have [Paper: PDF p. 7, Figure 3]*
...
- **Model dependence:** Results are conditional on GPT-4 agent with a four-stage generation, self-verification, modification and summarization loop that autonomously queries expert-curated biological databases through web APIs [Paper: PDF pp. 1–2]
